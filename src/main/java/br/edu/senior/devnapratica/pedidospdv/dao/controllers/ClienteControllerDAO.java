...
import br.edu.senior.devnapratica.pedidospdv.dao.services.ClienteServiceDAO;
...
public class ClienteControllerDAO {
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v0/clientes")
	public ResponseEntity<List<Cliente>> listar() {
		List<Cliente> clientes = clienteService.buscarTodos();
		return ResponseEntity.ok(clientes);
	}
	
	@RequestMapping(method = RequestMethod.POST, path = "/v0/clientes")
	public ResponseEntity<Cliente> salvar(@RequestBody Cliente cliente) {
		Cliente clienteSalvo = clienteService.salvar(cliente);
		return new ResponseEntity<>(clienteSalvo, HttpStatus.CREATED);
	}
	
	@RequestMapping(method = RequestMethod.GET, path = "/v0/clientes/{clienteId}")
	...
	@RequestMapping(method = RequestMethod.PUT, path = "/v0/clientes/{cliente.id}")
	...
	@RequestMapping(method = RequestMethod.DELETE, path = "/v0/clientes/{clienteId}")
